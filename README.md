# 🍔 Food Classification-Nutrition Analysis - AI
...
<img width="100%" alt="Before Prediction" src="before-prediction.png">
...
- Explore nutrition analysis features

---

## 🔹 Upload & Model Selection Interface

<img width="100%" alt="Upload UI" src="upload-ui.png">

This section demonstrates:

- Drag & Drop food image upload
- CNN / VGG16 / ResNet50 model selection
- Redis-based nutrition system
- Real-time preprocessing pipeline
- Intelligent food classification workflow

---

## 🔹 After Prediction

<img width="100%" alt="After Prediction" src="after-prediction.png">
